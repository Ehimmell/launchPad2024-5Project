...
@Component({
  selector: 'app-sliding-chart',
  standalone: true,
  imports: [],
  templateUrl: './sliding-chart.component.html',
  styleUrls: ['./sliding-chart.component.css']
})
export class SlidingChartComponent implements AfterViewInit {
